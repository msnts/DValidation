...
uses
  ...
  DValidation.Constraints.Number in '..\source\constraints\DValidation.Constraints.Number.pas',
  DValidation.Constraints.DecimalMaxTest in 'constraints\DValidation.Constraints.DecimalMaxTest.pas',
  DValidation.Constraints.DecimalMinTest in 'constraints\DValidation.Constraints.DecimalMinTest.pas',
  DValidation.Constraints.MinTest in 'constraints\DValidation.Constraints.MinTest.pas',
  DValidation.Constraints.MaxTest in 'constraints\DValidation.Constraints.MaxTest.pas',
  DValidation.Constraints.AssertFalseTest in 'constraints\DValidation.Constraints.AssertFalseTest.pas',
  DValidation.Constraints.AssertTrueTest in 'constraints\DValidation.Constraints.AssertTrueTest.pas',
  DValidation.Constraints.NotBlankTest in 'constraints\DValidation.Constraints.NotBlankTest.pas',
  DValidation.Constraints.NotEmptyTest in 'constraints\DValidation.Constraints.NotEmptyTest.pas',
  DValidation.Constraints.NotNullTest in 'constraints\DValidation.Constraints.NotNullTest.pas',
  DValidation.Constraints.PastTest in 'constraints\DValidation.Constraints.PastTest.pas',
  DValidation.Constraints.PastOrPresentTest in 'constraints\DValidation.Constraints.PastOrPresentTest.pas',
  DValidation.Constraints.PositiveTest in 'constraints\DValidation.Constraints.PositiveTest.pas',
  DValidation.Constraints.PositiveOrZeroTest in 'constraints\DValidation.Constraints.PositiveOrZeroTest.pas',
  DValidation.Constraints.FutureTest in 'constraints\DValidation.Constraints.FutureTest.pas',
  DValidation.Constraints.FutureOrPresentTest in 'constraints\DValidation.Constraints.FutureOrPresentTest.pas',
  DValidation.Constraints.NegativeTest in 'constraints\DValidation.Constraints.NegativeTest.pas',
  DValidation.Constraints.NegativeOrZeroTest in 'constraints\DValidation.Constraints.NegativeOrZeroTest.pas',
  DValidation.Constraints.NumberRange in '..\source\constraints\DValidation.Constraints.NumberRange.pas',
  DValidation.Constraints.Time.Future in '..\source\constraints\time\DValidation.Constraints.Time.Future.pas',
  DValidation.Constraints.Time.FutureOrPresent in '..\source\constraints\time\DValidation.Constraints.Time.FutureOrPresent.pas',
  DValidation.Constraints.Time.Past in '..\source\constraints\time\DValidation.Constraints.Time.Past.pas',
  DValidation.Constraints.Time.PastOrPresent in '..\source\constraints\time\DValidation.Constraints.Time.PastOrPresent.pas';
